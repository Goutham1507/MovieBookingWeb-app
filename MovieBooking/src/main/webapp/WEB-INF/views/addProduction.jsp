...
<body>
<a style ="float: right" href="adminHome.htm">Go Back to Menu Page</a>
<form:form action="addProduction.htm" commandName="production" method="post">
<pre>
<h1>Please enter the details</h1>
<hr>
<b>Producer Name:</b>
<form:input type="text" path="productionName" name="productionName" size="40" required="required"/>
<br><br><br>
<b>Owner:</b>
 <form:input  type="text" path="owner" name="owner" size="40" required="required" />
<br><br><br>
			  <input id="submit" type="submit" value="Add Production" />
</pre>
</form:form>
</body>
</html>